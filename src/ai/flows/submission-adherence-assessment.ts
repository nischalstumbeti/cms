// AI flow for assessing submission adherence to contest prompts.
'use server';
...
// DISABLED: Adherence and rationale fields have been removed from submissions
export async function assessSubmissionAdherence(
  input: SubmissionAdherenceInput
): Promise<SubmissionAdherenceOutput> {
  // Return default values since adherence assessment is disabled
  return {
    adherenceScore: 0,
    rationale: 'Adherence assessment has been disabled.'
  };
}
